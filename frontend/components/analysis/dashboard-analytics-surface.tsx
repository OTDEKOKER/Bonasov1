...
import { LayoutGrid, Loader2, Pencil, RotateCcw } from "lucide-react";

import { AnalyticsFilterBar } from "@/components/analysis/analytics-filter-bar";
...
function DashboardVisualizationPanels(props: {
  ...
  return (
    <>
      <section className="rounded-[1.4rem] border border-border bg-card p-4 shadow-sm">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <Badge variant="outline">Dashboard #{dashboardId}</Badge>
              {hasInteraction ? <Badge variant="secondary">Drilldown active</Badge> : null}
            </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Button
              ...
              size="sm"
              onClick={() => setDensity((value) => (value === "compact" ? "normal" : "compact"))}
            >
            ...
            <Button
              ...
              size="sm"
              onClick={() => setLayoutMode((value) => (value === "focus" ? "quad" : "focus"))}
            >
              {layoutMode === "focus" ? "Quad view" : "Focus view"}
            </Button>

            {hasInteraction ? (
              <Button variant="outline" size="sm" onClick={clearInteraction}>
    ...
    return (
      <section className="space-y-8">
        ...
        <AnalyticsEmptyState
          ...
          message="Choose at least one indicator to render analytics."
        />
      </section>
    );
  }
